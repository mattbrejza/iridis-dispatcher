...
if ('tex' in args.keys()):
   f.write(textwrap.dedent("""\
      ...
      set style line 1 lt 1 ps 1 pt 1 lc rgb '""" + rice_colour + """'
      set style line 2 lt 1 ps 1 pt 1 lc rgb '""" + expg_colour + """'
      set style line 3 lt 1 ps 1 pt 1 lc rgb '""" + ricecc_colour + """'
      set style line 4 lt 1 ps 1 pt 1 lc rgb '""" + expgcc_colour + """'
      set style line 5 lt 1 ps 1 pt 1 lc rgb '""" + uec_colour + """'
      set style line 6 lt 1 ps 1 pt 1 lc rgb '""" + vlec_colour + """'
      set style line 7 lt 1 ps 1 pt 1 lc rgb 'purple'
      
      set style line 11 lt 1 ps 1 pt 6 lc rgb '""" + expg_colour + """'    #ExpGEC
      set style line 12 lt 1 ps 1 pt 7 lc rgb '""" + expg_colour + """'    #ExpGEC
      set style line 13 lt 1 ps 1 pt 8 lc rgb '""" + expg_colour + """'    #ExpGEC
      set style line 14 lt 1 ps 1 pt 9 lc rgb '""" + expg_colour + """'    #ExpGEC
      set style line 15 lt 1 ps 1 pt 5 lc rgb '""" + expg_colour + """'    #ExpGEC
      
      set style line 21 lt 1 ps 1 pt 4 lc rgb '""" + rice_colour + """'    #RiceEC
      set style line 22 lt 1 ps 1 pt 5 lc rgb '""" + rice_colour + """'    #RiceEC
      set style line 23 lt 1 ps 1 pt 1 lc rgb '""" + rice_colour + """'    #RiceEC
      set style line 24 lt 1 ps 1 pt 2 lc rgb '""" + rice_colour + """'    #RiceEC
      set style line 25 lt 1 ps 1 pt 3 lc rgb '""" + rice_colour + """'    #RiceEC
      
      set style line 31 lt 2 ps 1 pt 1 lc rgb '""" + expgcc_colour + """'    #Expg
      set style line 32 lt 2 ps 1 pt 2 lc rgb '""" + expgcc_colour + """'    #Expg
      set style line 33 lt 2 ps 1 pt 3 lc rgb '""" + expgcc_colour + """'    #Expg
      set style line 34 lt 2 ps 1 pt 4 lc rgb '""" + expgcc_colour + """'    #Expg
      set style line 41 lt 2 ps 1 pt 2 lc rgb '""" + ricecc_colour + """'    #Rice
      set style line 42 lt 2 ps 1 pt 3 lc rgb '""" + ricecc_colour + """'    #Rice
      set style line 43 lt 2 ps 1 pt 4 lc rgb '""" + ricecc_colour + """'    #Rice
      set style line 44 lt 2 ps 1 pt 5 lc rgb '""" + ricecc_colour + """'    #Rice
      set style line 51 lt 2 ps 1 pt 3 lc rgb '""" + vlec_colour + """'    #VLEC
...
for ptr in display_order:
   ...
   if (lt_list[ptr] == ''):
      if "vlec" in run_name:
         ...
         style = str(expgcc_style);
         expgcc_style+=1
         colour = "green"
      elif "rice_cc" in run_name:
         style = str(ricecc_style);
         ricecc_style+=1
         colour = "red"
      elif "expg" in run_name:
         style = str(expgec_style);
         expgec_style+=1
         colour = "blue"
      elif "rice" in run_name:
         style = str(riceec_style);
         riceec_style+=1
         colour = "black"
   else:
      style = lt_list[ptr]
